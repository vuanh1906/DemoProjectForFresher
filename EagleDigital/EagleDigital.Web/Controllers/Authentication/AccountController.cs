...
namespace EagleDigital.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                {
                    ...
                    if (!userRoles.Contains(RoleConstants.Admin) && userRoles.Contains(RoleConstants.Obituary))
                    {
                        return RedirectToAction("List", "Obituary");
                    }
                    return RedirectToLocal(returnUrl);
                }
        ...
        [System.Web.Http.Route("forgot-password-confirm")]
        [System.Web.Mvc.AllowAnonymous]
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            {
                if (User.IsInRole(RoleConstants.Obituary))
                {
                    return RedirectToAction("List", "Obituary");
                }
            }
