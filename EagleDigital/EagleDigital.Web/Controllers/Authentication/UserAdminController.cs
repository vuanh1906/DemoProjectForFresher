...
namespace EagleDigital.Web.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,DisplayName")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user.Id == 1 && selectedRole.All(x => x != RoleConstants.Admin))
                {
                    var roles = selectedRole.ToList();
                    roles.Add(RoleConstants.Admin);
                    selectedRole = roles.ToArray();
                }
